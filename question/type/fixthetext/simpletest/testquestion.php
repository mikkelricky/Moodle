...
/**
 * Unit tests for the fix the text question definition class.
 *
 * @package    qtype
 ...
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class qtype_fixthetext_question_test extends UnitTestCase {
    ...
    public function test_is_complete_response() {
        $question = test_question_maker::make_a_fixthetext_question();
    ...
    public function test_get_question_summary() {
        $sa = test_question_maker::make_a_fixthetext_question();
